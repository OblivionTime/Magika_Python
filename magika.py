...
from content_types import ContentType, ContentTypesManager
from logger import get_logger
from prediction_mode import PredictionMode
from seekable import Buffer, File, Seekable
...
class Magika:
    ...
    def _get_result_from_labels_and_score(
        ...
        output_extensions=self._ctm.get_extensions(output_ct_label)
